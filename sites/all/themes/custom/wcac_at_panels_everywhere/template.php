 ...
 */
function wcac_at_panels_everywhere_preprocess_html(&$vars) {
  global $theme_key;
 ...
 */
function wcac_at_panels_everywhere_preprocess_atpe_site_template(&$vars) {
  global $theme_key;
  $theme_name = $theme_key;
 ...
 * Preprocess Site Template
 */
function wcac_at_panels_everywhere_preprocess_atpe_site_template_fww(&$vars) {
  global $theme_key;
  $theme_name = $theme_key;
 ...
 */
function wcac_at_panels_everywhere_preprocess_pane_header(&$vars) {
  global $theme_key;
  $theme_name = $theme_key;
 ...
 * Process pane header
 */
function wcac_at_panels_everywhere_process_pane_header(&$vars) {
 ...
 */
function wcac_at_panels_everywhere_preprocess_pane_navigation(&$vars) {
 ...
 * Preprocess pane navigation vars
 */
function wcac_at_panels_everywhere_process_pane_navigation(&$vars) {
  // theme the menu bars
...
function wcac_at_panels_everywhere_preprocess_pane_messages(&$vars) {
